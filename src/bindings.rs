...
pub const SCTP_RTOINFO: ::std::os::raw::c_int = 1;
pub const SCTP_ASSOCINFO: ::std::os::raw::c_int = 2;
pub const SCTP_INITMSG: ::std::os::raw::c_int = 3;
pub const SCTP_NODELAY: ::std::os::raw::c_int = 4;
pub const SCTP_AUTOCLOSE: ::std::os::raw::c_int = 5;
pub const SCTP_PRIMARY_ADDR: ::std::os::raw::c_int = 7;
pub const SCTP_ADAPTATION_LAYER: ::std::os::raw::c_int = 8;
pub const SCTP_DISABLE_FRAGMENTS: ::std::os::raw::c_int = 9;
pub const SCTP_PEER_ADDR_PARAMS: ::std::os::raw::c_int = 10;
pub const SCTP_I_WANT_MAPPED_V4_ADDR: ::std::os::raw::c_int = 13;
pub const SCTP_MAXSEG: ::std::os::raw::c_int = 14;
pub const SCTP_DELAYED_SACK: ::std::os::raw::c_int = 15;
pub const SCTP_FRAGMENT_INTERLEAVE: ::std::os::raw::c_int = 16;
pub const SCTP_PARTIAL_DELIVERY_POINT: ::std::os::raw::c_int = 17;
pub const SCTP_HMAC_IDENT: ::std::os::raw::c_int = 20;
pub const SCTP_AUTH_ACTIVE_KEY: ::std::os::raw::c_int = 21;
pub const SCTP_AUTO_ASCONF: ::std::os::raw::c_int = 24;
pub const SCTP_MAX_BURST: ::std::os::raw::c_int = 25;
pub const SCTP_CONTEXT: ::std::os::raw::c_int = 26;
pub const SCTP_EXPLICIT_EOR: ::std::os::raw::c_int = 27;
pub const SCTP_REUSE_PORT: ::std::os::raw::c_int = 28;
pub const SCTP_EVENT: ::std::os::raw::c_int = 30;
pub const SCTP_RECVRCVINFO: ::std::os::raw::c_int = 31;
pub const SCTP_RECVNXTINFO: ::std::os::raw::c_int = 32;
pub const SCTP_DEFAULT_SNDINFO: ::std::os::raw::c_int = 33;
pub const SCTP_DEFAULT_PRINFO: ::std::os::raw::c_int = 34;
pub const SCTP_REMOTE_UDP_ENCAPS_PORT: ::std::os::raw::c_int = 36;
pub const SCTP_ENABLE_STREAM_RESET: ::std::os::raw::c_int = 2304;
pub const SCTP_PLUGGABLE_SS: ::std::os::raw::c_int = 4611;
pub const SCTP_SS_VALUE: ::std::os::raw::c_int = 4612;
pub const SCTP_STATUS: ::std::os::raw::c_int = 256;
pub const SCTP_GET_PEER_ADDR_INFO: ::std::os::raw::c_int = 257;
pub const SCTP_PEER_AUTH_CHUNKS: ::std::os::raw::c_int = 258;
pub const SCTP_LOCAL_AUTH_CHUNKS: ::std::os::raw::c_int = 259;
pub const SCTP_GET_ASSOC_NUMBER: ::std::os::raw::c_int = 260;
pub const SCTP_GET_ASSOC_ID_LIST: ::std::os::raw::c_int = 261;
pub const SCTP_TIMEOUTS: ::std::os::raw::c_int = 262;
pub const SCTP_PR_STREAM_STATUS: ::std::os::raw::c_int = 263;
pub const SCTP_PR_ASSOC_STATUS: ::std::os::raw::c_int = 264;
pub const SCTP_SET_PEER_PRIMARY_ADDR: ::std::os::raw::c_int = 6;
pub const SCTP_AUTH_CHUNK: ::std::os::raw::c_int = 18;
pub const SCTP_AUTH_KEY: ::std::os::raw::c_int = 19;
pub const SCTP_AUTH_DEACTIVATE_KEY: ::std::os::raw::c_int = 29;
pub const SCTP_AUTH_DELETE_KEY: ::std::os::raw::c_int = 22;
pub const SCTP_RESET_STREAMS: ::std::os::raw::c_int = 2305;
pub const SCTP_RESET_ASSOC: ::std::os::raw::c_int = 2306;
pub const SCTP_ADD_STREAMS: ::std::os::raw::c_int = 2307;
